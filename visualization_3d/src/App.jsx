...
export default function App() {
  ...
  const animate = (time) => {
    if (lastTimeRef.current !== undefined && isPlaying && activeMode === 'prototype' && !showEntryModal) {
  ...
  }, [isPlaying, playbackSpeed, activeMode, showEntryModal]);
  ...
  return (
    <div className="app-container">
      {/* Entry Selection Modal on site load */}
      {showEntryModal && <EntryModal onSelectMode={handleSelectEntryMode} />}

      {activeMode === 'project' ? (
        <ProjectModeContainer activeMode={activeMode} onSwitchMode={handleSwitchMode} />
      ) : (
        <>
